...
export const Navbar = () => {
    return (
        <nav class="bg-aFuerte w-full shadow z-10">
            <div class="container m-auto flex justify-between items-center text-cyan-600">
                ...
                <ul class="hidden md:flex items-center pr-10 text-sky-200 font-semibold cursor-pointer">
                    ...
                    <Link to="/login" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"> Login</Link>
                    <Link to="/registro" type="button" class="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" >Registrarse</Link>
                </ul>

                <button  class=" block md:hidden py-3 px-4 rounde focus:outline-none hover:bg-gray-200 group z-10">
                    <div class="w-5 h-1 bg-gray-300 mb-1"></div>
                    <div class="w-5 h-1 bg-gray-300 mb-1"></div>
                    <div class="w-5 h-1 bg-gray-300 "></div>
